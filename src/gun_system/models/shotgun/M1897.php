...
class M1897 extends Shotgun
{
    public function __construct(ShotgunBulletType $bulletType, TaskScheduler $scheduler) {
        parent::__construct($bulletType, 12, new BulletDamage(10, 5), new GunRate(2.3), new BulletSpeed(333), 5, 2, new ReloadDetail(false,0,0,0.5), new EffectiveRange(0, 15), new GunPrecision(80,80), $scheduler);
    }
}