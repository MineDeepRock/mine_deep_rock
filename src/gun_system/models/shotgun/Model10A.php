...
class Model10A extends Shotgun
{
    public function __construct(ShotgunBulletType $bulletType, TaskScheduler $scheduler) {
        parent::__construct($bulletType, 12, new BulletDamage(12, 6), new GunRate(1.3), new BulletSpeed(333),  2, new OneByOneReloadController(6,0.5), new EffectiveRange(0, 20), new GunPrecision(90,86), $scheduler);
    }
}